...
export type RequestParams<M extends PluginMethod> =
  M extends 'ping'
    ? PingParams
...
export type PluginRequest = (
  ...
  | { type: 'request'; id: string; method: 'get_selection'; params: GetSelectionParams }
  | { type: 'request'; id: string; method: 'execute'; params: ExecuteParams }
  | { type: 'request'; id: string; method: 'create_svg'; params: CreateSvgParams }
  | { type: 'request'; id: string; method: 'update_selection'; params: UpdateSelectionParams }
  | { type: 'request'; id: string; method: 'find'; params: FindParams }
  | { type: 'request'; id: string; method: 'set_selection'; params: SetSelectionParams }
  ...
  | { type: 'request'; id: string; method: 'fill_image'; params: FillImageParams }
  | { type: 'request'; id: string; method: 'list_fonts'; params: ListFontsParams }
) & {
...
export function makeResponse<D>(id: string, ok: boolean, data?: D, error?: string): PluginResponse<D> {
